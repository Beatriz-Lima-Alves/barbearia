...
define('SITE_URL', 'http://localhost/barbearia-new');
define('SITE_NAME', 'Sistema Barbearia');
...
define('SMTP_FROM', 'noreply@barbearia.com');
define('SMTP_FROM_NAME', 'Sistema Barbearia');

/**
 * Classe Database - Singleton para conexão com MySQL
 */
class Database {
...
/**
 * Classe utilitária para operações comuns do banco
 */
class DB {
    ...
    /**
     * Executa uma consulta SELECT retornando apenas um registro
     */
